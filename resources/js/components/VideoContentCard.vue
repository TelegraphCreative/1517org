<template>
  <div class="content-card__container | flex-grid md:flex-row-reverse mb-4">
    <a
      href="#"
      @click.prevent
      class="content-card__media relative cursor-default | no-print overflow-hidden"
    >
      <img
        :src="imgSrc"
        :class="{ hidden: hideImg }"
        class="video-cover -hover-scale absolute z-10"
      >
    ...
    <div class="content-card__content">
      ...
      <div class="content-card__action -play-podcast | mb-6">
        <a v-if="player" @click.prevent="togglePlayback" class="btn -xs -media -has-icon" href="#">
